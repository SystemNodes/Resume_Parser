...
def parse_resume(resume_text):
    ...
    try:
        ...
        experience_match = re.search(r'WORK EXPERIENCE(.*?)(EDUCATION|ADDITIONAL EXPERIENCE|PUBLICATIONS|CONFERENCES|LANGUAGES)', resume_text, re.DOTALL | re.IGNORECASE)
        skills_match = re.search(r'TECHNICAL PROFICIENCIES(.*?)(WORK EXPERIENCE|EDUCATION|ADDITIONAL EXPERIENCE|PUBLICATIONS|CONFERENCES|LANGUAGES)', resume_text, re.DOTALL | re.IGNORECASE)
